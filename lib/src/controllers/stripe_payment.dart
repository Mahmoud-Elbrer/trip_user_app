...
class StripeServices {
  ...
  static String secret = 'sk_test_51LqJZhAYdejhgXhKuEBaFAo01KmpW1LDprA1PMasZ9K9ldjMNe1MUuJPUmU9eqDTXLDSE7HYwZHofjB06aw9tFqH00qgg7Tzns';
  ...
  static init() {
    StripePayment.setOptions(StripeOptions(
        publishableKey: 'pk_test_51LqJZhAYdejhgXhKneGuXWF4w4datxwZvODbDyrEnhggQp4SwrLeQWpaIktkqHBP5jSwVfLyUMWjN7rnlm4Rpus6005ERpqcL0',
        androidPayMode: 'test',
        merchantId: 'test'));
  }
  ...
  static Future<StripeTransactionResponse> payNowHandler(
    ...
    try {
      ...
      return StripeTransactionResponse(
          message: 'Transaction failed in the catch block error is : '+error.toString(), success: false);
